package it.unipv.pois.Banca.mvc.view;
...
public class AccountPanel extends JPanel {
	...
	private static final String [] ACC_OPERATIONS = {	
			"Prelievo,",
			"Deposito",
			"Stampa Dettagli",
			"Aggiungi un accredito/addebito mensile",
			"Rimuovi un accredito/addebito mensile"
	...
	public Integer getCifraAccreditoDeposito() {
		
		try {
			int cifra_acc_dep = Integer.parseInt(cifra.getText());
